...
@Autonomous(name="BlueLong3Ball", group="SCC")
public class BlueLong3Ball extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {

        // Define the field positions
        Pose2d startPos = new Pose2d(62, -13, Math.toRadians(0));
        Pose2d launchPos = new Pose2d(54, -11, Math.toRadians(22));
        Pose2d parkPos = new Pose2d(54, -37, Math.toRadians(0));
        Pose2d tapeMarkStart = new Pose2d(34, -28, Math.toRadians(270));
        Pose2d tapeMarkEnd = new Pose2d(34, -58, Math.toRadians(270));
