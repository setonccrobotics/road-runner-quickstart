...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2587.528954874382;//-2753.596241613808; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 3155.9895728543383;//2929.8055950494922; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -989.6919944934302;//-1136.2031056402107; // x position of the perpendicular encoder (in tick units)
    }
