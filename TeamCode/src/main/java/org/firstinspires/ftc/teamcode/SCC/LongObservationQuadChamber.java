...
@Autonomous(name="LongObservationQuadChamber", group="SCC")
public class LongObservationQuadChamber extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d sampleTwoPos = new Pose2d(38.5, -44, Math.toRadians(60.0));
        ...
        Pose2d parkPos = new Pose2d(9, -53, Math.toRadians(270.0));
        ...
        clawAssembly.setWristPos(0.43);
        sleep(200);
        liftAssembly.slideToEncoderPosBlocking(1560);//1563);
